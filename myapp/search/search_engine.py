...
class SearchEngine:
    ...
    def search(self, search_query,  query_terms, corpus, corpus_dataframe, index, tf, idf, bm25, selected_engine):
        ...
        results = search_in_corpus(search_query, query_terms, corpus, corpus_dataframe, index, tf, idf, bm25, selected_engine)
